...
Wind & 48 & 48 & 48 h & positive skill across full range ($h=1..48$) \\
Traffic & ? & ? & ? &  \\
\bottomrule
\end{tabular}
\caption{Predictability horizon comparison across domains (current draft with PM$_{2.5}$, energy, and wind results).}
\label{tab:results}
\end{table}
