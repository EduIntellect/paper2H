...
INPUT_CSV = Path("results/pm25_lightgbm_full_skill.csv")
OUTPUT_PDF = Path("figures/fig_skill_pm25.pdf")
OUTPUT_PNG = Path("figures/fig_skill_pm25.png")


def main() -> None:
    df = pd.read_csv(INPUT_CSV)

    # Required canonical columns for the final PM2.5 Skill(h) figure.
